...
import { CURRENT_STUDENT, generateAttendance, DAYS, MONTHS } from '../data';
import BrandLogo from '../components/BrandLogo';

const WEEKLY_MENU = {
  Mon: { lunch: 'Dal Tadka, Roti, Chawal, Aloo Gobi', dinner: 'Rajma, Roti, Jeera Rice, Raita' },
  Tue: { lunch: 'Chole, Roti, Chawal, Bhindi Fry', dinner: 'Paneer Butter Masala, Roti, Chawal' },
  ...
  Sat: { lunch: 'Aloo Gobi, Dal Tadka, Roti, Chawal', dinner: 'Matar Paneer, Roti, Chawal' },
  Sun: { lunch: 'Special Thali — Poori, Chole, Kheer', dinner: 'Dal Fry, Roti, Chawal, Sabzi' },
};
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-x-hidden">
        ...
        <header className="bg-white border-b border-brand-surface/40 px-6 sm:px-8 h-20 flex items-center justify-between sticky top-0 z-30 shadow-premium-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-lg font-bold text-brand-secondary">Namaste, {CURRENT_STUDENT.fullName}</h1>
              <p className="text-[10px] font-medium text-warm-500">{CURRENT_STUDENT.messName} • Student Portal</p>
            </div>
          </div>
